        ...
        'site'         => function ($event, $app) {
            $app->on('view.content', function ($event, $scripts) use ($app) {
                ...
                if ($visibleonly = (array_key_exists('visibleonly', $config)
                    ...
                    if (is_bool($visibleonly)) {
                        $options[] = $visibleonly ? 'visibleOnly: true'
                            : 'visibleOnly: false';
                    }
                }
                ...
                if ($enabledefaultimage = (array_key_exists('enabled',
                    ...
                    if ($datauri = (array_key_exists('datauri',
                        $config['defaultimage'])
                        ? $config['defaultimage']['datauri'] : false)
                    ) {
                        if ($datauri) {
                            $options[]
                ...
                if ($enablecallback = (array_key_exists('enabled',
                    ...
                    if ($onfinishedall = (array_key_exists('onfinishedall',
                        $config['callback'])
                        ? $config['callback']['onfinishedall'] : false)
                    ) {
